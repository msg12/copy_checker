...
no_of_questions,no_of_students=2,1 #Creating global variables for no of questions and no of students.......
# import drive_func
import os
...
# MainObjectGD=drive_func.gdrive() 
...
def model_things():
    ...
    for i in range(no_of_questions):
        idcaught=MainObjectGD.uploadconverted(modelimgpath+'img'+str(i+1)+'.png') 
        MainObjectGD.download(idcaught,modeltextpath+'q'+str(i+1))
